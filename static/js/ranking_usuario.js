document.addEventListener("DOMContentLoaded", async () => {
  ...
  const tabela = document.querySelector("#rankingTabelaUser tbody");
  const pesquisa = document.getElementById("pesquisaJogadorUser");
  const grafico = document.getElementById("graficoRankingUser");
  let dados = [];
  let chart;
